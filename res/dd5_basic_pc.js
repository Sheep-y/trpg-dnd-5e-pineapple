...
{ entry:'race', id: 'dwarf', subrules: [
   ...
   ' prof.weapon     : db.equipment({ id: [ "battleaxe", "handaxe", "light-hammer", "warhammer" ] }) ',
   ' profSlot.tool.bonus_prof : db.equipment({ id: [ "smith-tool", "brewer-tool", "mason-tool" ] }) ',
...
{ entry:'feature', id: 'dwarf-mountain', type: 'subrace', of: 'dwarf', subrules: [
   ' adj.str : 2 ',
   ' prof.armour : db.equipment({ armour: [ "light", "medium" ] }) ',
] },
////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
{ entry:'feature', id: 'elf-high', type: 'subrace', of: 'elf', subrules: [
   ' adj.int : 1 ',
   ' prof.weapon : db.equipment({ id: [ "longsword", "shortsword", "shortbow", "longbow" ] }) ',
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
{ entry:'equipment', type: 'weapon', id: 'handaxe', melee:1, simple:1, damage:"1d6", dmg_type: "slashing",
   cost:  5, weight: 2, light:1, thrown: [20,60] },
{ entry:'equipment', type: 'weapon', id: 'light-hammer', melee:1, simple:1, damage:"1d4", dmg_type: "bludgeoning",
   cost:  2, weight: 2, light:1, thrown: [20,60] },
{ entry:'equipment', type: 'weapon', id: 'battleaxe', melee:1, martial:1, damage:"1d8", dmg_type: "slashing",
   cost: 10, weight: 4, versatile:"1d10" },
{ entry:'equipment', type: 'weapon', id: 'longsword', melee:1, martial:1, damage:"1d8", dmg_type: "slashing",
   cost: 15, weight: 3, versatile:"1d10" },
{ entry:'equipment', type: 'weapon', id: 'shortsword', melee:1, martial:1, damage:"1d6", dmg_type: "piercing",
   cost: 10, weight: 2, finesse:1, light:1 },
{ entry:'equipment', type: 'weapon', id: 'warhammer', melee:1, martial:1, damage:"1d8", dmg_type: "bludgeoning",
   cost: 15, weight: 2, versatile:"1d10" },
{ entry:'equipment', type: 'weapon', id: 'shortbow', ranged:[80,320], simple:1, damage:"1d6", dmg_type: "piercing",
   cost: 25, weight: 2, ammunition:1, 'two-handed':1 },
{ entry:'equipment', type: 'weapon', id: 'longbow', ranged:[150,600], martial:1, damage:"1d8", dmg_type: "piercing",
