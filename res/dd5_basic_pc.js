...
{ entry:'character', id: 'pc', subrules: [ // Standard PC
   ...
   { slot: 'bonus_language', count: 'you.queryChar( "int_mod", this, undefined, 1 )', options: 'db.entity({ language: "standard" })', dependent_attribute: 'int_mod' },
...
{ entry:'equipment', type: 'armour', id: 'hide'          , armour: 'medium', cost: 10, weight: 12, subrules: [ 'adj.ac: 2', 'negate.ac: dex_to_ac [,2]' ] },
{ entry:'equipment', type: 'armour', id: 'chainshirt'    , armour: 'medium', cost: 50, weight: 20, subrules: [ 'adj.ac: 3', 'negate.ac: dex_to_ac [,2]' ] },
{ entry:'equipment', type: 'armour', id: 'scalemail'     , armour: 'medium', cost: 50, weight: 45, subrules: [ 'adj.ac: 4', 'negate.ac: dex_to_ac [,2]' ] },
{ entry:'equipment', type: 'armour', id: 'breastplate'   , armour: 'medium', cost:400, weight: 20, subrules: [ 'adj.ac: 4', 'negate.ac: dex_to_ac [,2]' ] },
{ entry:'equipment', type: 'armour', id: 'halfplate'     , armour: 'medium', cost:750, weight: 40, subrules: [ 'adj.ac: 5', 'negate.ac: dex_to_ac [,2]' ] },
{ entry:'equipment', type: 'armour', id: 'ringmail'      , armour: 'heavy' , cost: 30, weight: 40, subrules: [ 'adj.ac: 4', 'negate.ac: dex_to_ac' ] },
{ entry:'equipment', type: 'armour', id: 'chainmail'     , armour: 'heavy' , cost: 75, weight: 55, subrules: [ 'adj.ac: 6', 'negate.ac: dex_to_ac' ] }, // str 13
{ entry:'equipment', type: 'armour', id: 'splintmail'    , armour: 'heavy' , cost:200, weight: 60, subrules: [ 'adj.ac: 7', 'negate.ac: dex_to_ac' ] }, // str 15
{ entry:'equipment', type: 'armour', id: 'platemail'     , armour: 'heavy' ,cost:1500, weight: 65, subrules: [ 'adj.ac: 8', 'negate.ac: dex_to_ac' ] }, // str 15
